...
public class TextFieldUtils {
    ...
    public static JTextField createNumericTextField(
        ...
        // --- Focus background coloring ---
        textField.addFocusListener(new FocusAdapter() {
            @Override public void focusGained(FocusEvent e) { textField.setBackground(activeColor); }
            @Override public void focusLost(FocusEvent e) { textField.setBackground(Color.WHITE); }
        });

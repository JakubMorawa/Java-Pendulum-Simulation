...
public class Utils {
    ...
    public static void drawImage(Graphics2D g2, String imgPath, int x, int y, int width, int height) {
        BufferedImage image;
        try {
            image = ImageIO.read(new File(imgPath)); // Replace with your image path
        } catch (IOException e) {
            return;
        }
